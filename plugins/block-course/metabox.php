...
function blocks_course_post_options_metabox_html( $post ) {
	...
	?>
	<p>
		<label for="blocks_course_post_subtitle_field">
			<?php esc_html_e( 'Post Subtitle', 'blocks_course' ); ?>
		</label>
		<br />
		<input class="widefat" type="text" name="blocks_course_post_subtitle_field" id="blocks_course_post_subtitle_field"
